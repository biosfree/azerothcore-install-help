...
UnlimitedAmmoNamespace.ENABLED = true -- Set this to false to disable the script
local ANNOUNCE_ON_LOGIN = true
local ANNOUNCEMENT = "This server is running the |cFF00B0E8UnlimitedAmmo|r lua script."
...
UnlimitedAmmoNamespace.MAX_AMMO = 2 -- Maximum ammunition allowed
